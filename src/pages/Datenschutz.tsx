        ...
        <div className="container">
          ...
          <section className="legal-section">
            ...
            <p>
              ...
              von Daten an Steuerbehörden), wenn wir ein berechtigtes Interesse nach Art. 6 Abs. 1 lit. f DSGVO
              an der Weitergabe haben oder wenn eine sonstige Rechtsgrundlage die Datenweitergabe erlaubt.
            </p>
